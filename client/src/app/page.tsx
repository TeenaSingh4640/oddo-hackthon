        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mt-20 grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-neutral-900 mb-2">Points</h3>
              <p className="text-neutral-600">
                Gather points with every purchase and earn rewards for your eco-friendly choices.
              </p>
            </div>
          </div>

          {/* Stats Section */}
          <div className="mt-20 bg-white rounded-2xl p-8 shadow-sm border border-neutral-200">
            <h2 className="text-3xl font-bold text-center text-neutral-900 mb-8">Our Impact So Far</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-primary-600 mb-2">2.5M+</div>
                <div className="text-neutral-600">Items Reworn</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-accent-600 mb-2">150K+</div>
                <div className="text-neutral-600">Happy Users</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-primary-600 mb-2">520T</div>
